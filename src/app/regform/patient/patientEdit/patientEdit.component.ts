...
@Component({
  ...
  providers: [PatientEditService, NotificationsComponent]
})
export class PatientEditComponent implements OnInit {
  ...
  cities = [];
  selobj;
  constructor(private userService: PatientEditService, private router: Router,private formBuilder: FormBuilder, private route: ActivatedRoute, private notificationsComponent: NotificationsComponent) { }
  ngOnInit() {
