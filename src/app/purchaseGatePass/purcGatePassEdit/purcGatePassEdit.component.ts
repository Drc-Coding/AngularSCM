...
import {purcGatePassEditService} from './purcGatePassEdit.service' ;
...
@Component({
  selector: 'app-purcGatePassEdit',
  templateUrl: './purcGatePassEdit.component.html',
  providers: [purcGatePassEditService ,NgbDropdownConfig ,NotificationsComponent  ,  dateFormatPipe]
 
})
export class purcGatePassEditComponent implements OnInit {
  ...
  editdata=[]  ;
      ...
      constructor(private userService: purcGatePassEditService,private   dateformat: dateFormatPipe,private notificationsComponent:NotificationsComponent  ,private formBuilder: FormBuilder ,config: NgbDropdownConfig  ,private route: ActivatedRoute) {
