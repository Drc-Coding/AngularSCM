...
import { purcGatePassSaveService } from './purcGatePassSave.service';
...
@Component({
  selector: 'app-purcGatePass',
  templateUrl: './purcGatePassSave.component.html',
  styleUrls: ['./purcGatePassSave.component.css'],
  providers: [NotificationsComponent ,dateFormatPipe,purcGatePassSaveService]
})

export class purcGatePassSaveComponent implements OnInit, AfterViewInit {
  $: any;
  deliveryForm: any;
  @Input() searchText;
  ...
  polist = [];
  coltax: any;
  constructor(private invoiceService: purcGatePassSaveService, private router: Router, private formBuilder: FormBuilder, private notificationsComponent: NotificationsComponent, private appComponent: AppComponent) {
  ...
  ngOnInit() {
    ...
    this.deliveryForm.get('locname').setValue(AppComponent.locrefID1);
    this.deliveryForm.get('locrefid').setValue(AppComponent.locRefName1);
    this.deliveryForm.get('fromlocname').setValue(AppComponent.locrefID1);
    this.deliveryForm.get('fromlocrefid').setValue(AppComponent.locRefName1);
    ...
    this.deliveryForm.get('billtype').setValue("opt1");
  ...
  getFirm() {
    ...
    this.invoiceService.getHospital(this.deliveryForm.get('tolocname').value).subscribe(data => { this.firms = data  },
      ...
      if(this.deliveryForm.get('tolocname').value==1){  
        ...
        this.invoiceService.getUserShop(AppComponent.companyID,AppComponent.locRefName).subscribe(data => { this.firms = data },
          err => {
             console.log('Error Occured Get Warehouse');
          });
      ...
      if(this.deliveryForm.get('tolocname').value==2){  
        this.invoiceService.getUserWareHouse(AppComponent.companyID,AppComponent.locRefName).subscribe(data => { this.firms = data },
          err => {
             console.log('Error Occured Get Warehouse');
          });
      ...
      if(this.deliveryForm.get('tolocname').value==2){  
        this.invoiceService.getUserHospital(AppComponent.companyID,AppComponent.locRefName).subscribe(data => { this.firms = data },
          err => {
             console.log('Error Occured Get Warehouse');
          });
      }
            ...
            this.invoiceService.getDeliveryChallanProduct(JSON.stringify(saveData.value)).subscribe(
              data => { 
                if(data==true){
                  ...
                  window.location.href = "GatePass/GatePassView";
                }
              },
              error => {
