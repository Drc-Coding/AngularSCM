...
export class indentreqEditComponent implements OnInit {
  ...
  editdata=[]  ;
      ...
      constructor(private userService: indentreqEditService,private   dateformat: dateFormatPipe,private notificationsComponent:NotificationsComponent  ,private formBuilder: FormBuilder ,config: NgbDropdownConfig  ,private route: ActivatedRoute) {
