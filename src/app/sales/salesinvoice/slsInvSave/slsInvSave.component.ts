...
export class slsInvSaveComponent implements OnInit {
  ...
  constructor(private userService: slsInvSaveService, private dateformat: dateFormatPipe, private formBuilder: FormBuilder, 
    config: NgbDropdownConfig, private notificationsComponent: NotificationsComponent, 
    private modalService: NgbModal, private domSanitizer: DomSanitizer,private appComponent: AppComponent) {
