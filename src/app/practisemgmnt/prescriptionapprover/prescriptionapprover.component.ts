...
@Component({
  selector: 'app-prescriptionapprover',
  templateUrl: './prescriptionapprover.component.html',
  styleUrls: ['./prescriptionapprover.component.css'],
  providers: [PrescriptionApprovalService, NotificationsComponent]

})
export class PrescriptionapproverComponent implements OnInit {
  prescForm: any;
  imgurl;
  prescrplist: any;
  searchProducts = [];
  ...
  ngOnInit() {
    ...
    this.prescrepservice.getprescriptionapprlist(AppComponent.companyID, AppComponent.branchID, AppComponent.locRefName1, AppComponent.locrefID1).subscribe(
      data => {
