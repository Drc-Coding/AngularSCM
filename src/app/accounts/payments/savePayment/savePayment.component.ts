...
export class savePaymentComponent implements OnInit {
  ...
  constructor(private userService: savePaymentService, private dateformat: dateFormatPipe, private notificationsComponent: NotificationsComponent, private formBuilder: FormBuilder, config: NgbDropdownConfig) {
