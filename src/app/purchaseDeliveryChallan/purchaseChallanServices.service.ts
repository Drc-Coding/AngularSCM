...
@Injectable()
export class purchaseChallanServices {
  ...
  private getSuperStockNoURL= 'api/getsuperadminpurchaseinvoiceno';
  private getStockNoURL='api/getpurchaseno';
  private getAutonIncrement= 'api/getPurchaseDelveryAutoIncrements';
