...
@Component({
  ...
  templateUrl: './purchaseChallanSave.component.html',
  styleUrls: ['./purchaseChallanSave.component.css'],
  providers: [NotificationsComponent ,dateFormatPipe,purchaseChallanServices]
})

export class purchaseChallanSaveComponent implements OnInit, AfterViewInit {
  $: any;
  deliveryForm: any;
  @Input() searchText;
  ...
  polist = [];
  coltax: any;
  constructor(private challanService: purchaseChallanServices, private router: Router, private formBuilder: FormBuilder, private notificationsComponent: NotificationsComponent, private appComponent: AppComponent) {
